...
public class Constants {
    ...
    public static final int PERMISSION_SETTINGS_CODE = 90;
    public static final int LOCATION_PERMISSION_CODE = 100;
    public static final int BACKGROUND_LOCATION_PERMISSION_CODE = 110;
    ...
    public static final String IMAGES_CONTENT_TYPE = "image/jpeg";
